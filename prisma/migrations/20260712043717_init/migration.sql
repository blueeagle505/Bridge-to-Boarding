-- CreateEnum
CREATE TYPE "Role" AS ENUM ('APPLICANT', 'MENTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'MENTOR_ASSIGNED', 'WAITLISTED', 'REJECTED', 'CLOSED');

-- CreateEnum
CREATE TYPE "MentorApplicationStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "CurrentGrade" AS ENUM ('GRADE_7', 'GRADE_8');
...
CREATE TABLE "Application" (
    ...
    "state" TEXT NOT NULL,
    "currentGrade" "CurrentGrade" NOT NULL,
    "gpa" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "Application_mentorId_idx" ON "Application"("mentorId");
...
-- AddForeignKey
ALTER TABLE "Application" ADD CONSTRAINT "Application_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "MentorProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
